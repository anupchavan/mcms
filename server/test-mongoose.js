...
async function test() {
  await mongoose.connect('mongodb://127.0.0.1:27017/mcms_test', { serverSelectionTimeoutMS: 2000 });
  const schema1 = new mongoose.Schema({ meetingId: mongoose.Schema.Types.ObjectId, name: String });
