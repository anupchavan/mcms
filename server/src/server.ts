...
app.use('/api/action-items', require('./modules/action-item/action-item.routes')(deps));
app.use('/api/attendance', require('./modules/attendance/attendance.routes')(deps));
...
app.use('/api/dashboard', require('./modules/dashboard/dashboard.routes')(deps));
app.use('/api/notifications', require('./modules/notification/notification.routes')(deps));
app.use('/api/rsvp', require('./modules/rsvp/rsvp.routes')(deps));
app.use('/api/profile', require('./modules/profile/profile.routes')(deps));
app.use('/api/transcript', require('./modules/transcript/transcript.routes')(deps));
