...
export function FlexokiPin({ size = 32 }: { size?: number }) {
  ...
  return (
    <div
      ...
      style={{ width, height: size, lineHeight: 0, pointerEvents: "none" }}
    >
      <svg viewBox="0 0 24 36" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <path className="pin-body" d="M12 0C5.373 0 0 5.373 0 12c0 8.7 12 24 12 24s12-15.3 12-24c0-6.627-5.373-12-12-12z" />
