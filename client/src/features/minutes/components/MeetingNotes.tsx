...
const API_BASE = _raw.endsWith("/api")
    ? _raw
    : `${_raw.replace(/\/?$/, "")}/api`;
        ...
        <div className="meeting-notes-section">
            ...
            >
                <div className="section-title-container">
                    ...
                    {saving && (
                        <span className="notes-save-indicator">Saving...</span>
                    )}
                    {!saving && lastSaved && (
                    ...
                    <div className="notes-toolbar">
                        <div className="notes-toolbar-group" ref={headingRef}>
                            <ToolBtn
                                ...
                                title="Headings"
                            >
                                <span className="notes-heading-trigger">
                                    H<Icon icon={ArrowDown01Icon} size={10} />
                                </span>
                            </ToolBtn>
                            {headingOpen && (
                        ...
                        >
                            <span className="meeting-notes-code-label">
                                &lt;&gt;
                            </span>
                        </ToolBtn>
                        <ToolBtn
