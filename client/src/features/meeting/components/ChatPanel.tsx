...
const LinkifyContent = ({
    ...
    const linkColor = isSelf
        ? "rgba(var(--flexoki-paper-rgb), 0.92)"
        : "var(--primary)";
    return (
                ...
                <div className="chat-presence-avatar">
                    {avatarSrc ? (
                        <img
                            src={avatarSrc}
                            alt=""
                            className="chat-presence-avatar-img"
                        />
                    ) : isSelfRibbon ? (
                        "Y"
                    ) : (
                            ...
                            >
                                {messages.length === 0 ? (
                                    ...
                                    messages.map((msg, index) => {
                                        ...
                                        const showHead = isFirstFromSender(
                                            messages,
                                            index,
                                        );
                                        const showTail = isLastFromSender(
                                            messages,
                                            index,
                                        );
                                        ...
                                        const peerAvatarSrc = avatarUrlFromPath(
                                            msg.senderImage,
                                        );
                                        const isPinned =
                                            pinnedMessage?.id === msg.id;
                                        const showPin =
                                            isHost && Boolean(onPinMessage);
                                        const pinVisible =
                                            showPin &&
                                            (hoverMsgId === msg.id || isPinned);
                                                                ...
                                                                <div className="chat-peer-avatar-div">
                                                                    {peerAvatarSrc ? (
                                                                        <img
                                                                            ...
                                                                            alt=""
                                                                            className="chat-peer-avatar-img"
                                                                        />
                                                                    ) : (
                                                                        msg.senderName
                                                                            .charAt(
