...
const TailSvg: FC<{ fill: string; forOthers: boolean }> = ({
    fill,
    forOthers,
}) => (
    <svg
...
export const ChatBubbleSurface: FC<ChatBubbleSurfaceProps> = ({
    variant,
    showTail = true,
    children,
}) => {
    ...
    return (
        <div
            className={
                isMe
                    ? "chat-bubble-surface chat-bubble-surface--me"
                    : "chat-bubble-surface chat-bubble-surface--others"
            }
            style={{
                position: "relative",
