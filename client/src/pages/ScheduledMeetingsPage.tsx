...
export default function ScheduledMeetingsPage() {
    ...
    const filteredMeetings = useMemo(() => {
        ...
        const { textQuery, dateFrom, dateTo } =
            parseSearchInput(scheduleSearchQuery);
        const textLower = textQuery.toLowerCase();
        return upcomingMeetings.filter((m) => {
            let matchesText = true;
            if (textLower) {
                matchesText =
                    m.title?.toLowerCase().includes(textLower) ||
                    m.host?.toLowerCase().includes(textLower);
            }
        ...
        <div className="page-shell">
            <header className="page-header">
                ...
                <p className="page-header-description">
                    Upcoming sessions you can join — search by title, host, or
                            ...
                            meeting.pollId && (
                                <button
                                    ...
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        const pid =
                                            resolvedInternalMeetingId(meeting);
                                        if (pid) openPoll(pid);
                                    }}
                                >
                                    Vote
                        ...
                        <div className="meeting-card-meta">
                            ...
                            {shouldShowMeetingLocation(meeting) && (
                                <span
                                    ...
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        openLocationModal(meeting.location!);
                                    }}
                                >
